...
export const demoCalls: Call[] = [
  {
    ...
    outcome: { disposition: "PROMISE_TO_PAY", summary: "Customer committed to pay in full on Friday morning.", sentiment: "positive", duration_seconds: 52 },
  ...
  },
  {
    ...
    outcome: { disposition: "PAID", summary: "Customer reports payment completed through mobile app.", sentiment: "positive", duration_seconds: 38 },
  ...
  },
  {
    ...
    outcome: { disposition: "CALL_BACK", summary: "Requested a callback tomorrow after 6 PM.", sentiment: "neutral", duration_seconds: 44 },
  ...
  },
  {
    ...
    outcome: { disposition: "NO_ANSWER", summary: "Call rang without answer.", sentiment: "unknown", duration_seconds: 24 },
